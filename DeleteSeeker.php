...
<body background="image/4.jpg">
	...
	<div>
	<center>
	<h1><font color="2f3637">Delete</font> <font color="#ee2742">Employee</font></h1>
	<br>
	...
	-->
	<center>
    <form method="POST" action="DeleteSeek.php">
    <input type="text" name=email placeholder="Seeker Email"><br>
 ...
 <center>
 <a href="DeleteSeek.php"><button class="button2"><span>Delete</span></button></a></center>
</form>
	</center>
