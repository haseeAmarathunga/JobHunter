...
<body background="image/4.jpg">
	...
	<div>
	<center>
	<h1><font color="2f3637">Edit/Delete</font> <font color="#ee2742">seeker</font></h1>
	<br>
     ...
     //if($_SERVER["REQUEST_METHOD"] == "POST") {
         ...
         if ($result->num_rows > 0) {
             ...
             while($row = $result->fetch_assoc()) {
                 ...
                 echo("<button class='button2' onclick=\"location.href='DeleteSeeker.php'\">Delete</button><p>");
                 echo "--------------------------------------------------------------------------------------------- ";
