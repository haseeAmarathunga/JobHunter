...
<body>
	...
	<div class="container">
		...
		<h2 class="cat_title"><span id="redlight">Job</span> requests</h2>
	...
	<?php
		...
		//if($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			$sql = "SELECT fullName,nic,address,mobile,email,gender,age,experiance
			 FROM seekers WHERE em_email='$message'";
			$result = $db->query($sql);
			...
			if ($result->num_rows > 0) {
				...
				while($row = $result->fetch_assoc()) {
					...
					$row["experiance"]."<br>" ;
					echo("<button class='button2' onclick=\"location.href='confirm.php'\">Confirm</button><p>");
